...
**Sales Trends and Seasonal Changes (Normalized Quantitty by Months)**
The products sales trends by months are provided insight about the common traits in products trends by season:
...
![Figure Normalized Quantity of Products Ordered by Month](/Output/normQuantityProductsOrdByMonth.png){fig-alt="Plot show identification seasonal trends for each product. The insights drawn about common traits in product trends by season"}
*Figure 6: Normalized Quantity of Products Ordered by Month*
...
![Figure Sales Trends for Monitors and Headphones](/Output/monitorHeadphoneTopNorm.png){fig-alt="Consistent level of demand across all months"}
*Figure 7: Sales Trends for Monitors and Headphones and Batteries*

2. **Seasonal Peak Products**: **headpones** (Apple AirPods, Bose SoundSport), **monitor** show increased demand in certain months, particularly around November and December, likely due to holiday shopping and gift-giving. Some peaks may also align with back-to-school periods (e.g., Feburary, October) as consumers set up or upgrade their tech for school or remote work.
...
**Key Insights Products Analyse and Common Traits**
- **High-end, seasonal products** (monitors, premium headphones): High responsiveness to holiday seasons and promotions, driven by gift-giving and consumer upgrade behavior.
- **Essential, consistent-demand products** (batteries, charging cables): Steady year-round demand with minimal seasonal influence, purchased out of necessity or regular replacement needs
...
- Peak Sales Periods: Leverage the high sales volumes in December and October by planning targeted promotions and marketing campaigns around these times. Consider holiday-themed promotions, discounts, and special offers to attract more customers.
