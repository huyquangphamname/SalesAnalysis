...
**Key Insights for Top-Performing Cities**

- **San Francisco**:  With over $8 million in sales, San Francisco's high purchasing power, dense population, and tech-savvy market likely contribute to its dominance.


- **Los Angeles and New York City**: These cities benefit from large metropolitan areas and significant tourist activity, which boosts retail sales and creates consistent demand across various product categories.

**Key Insights for Low-Performing Cities**

- **Austin and Portland**: These cities show lower sales volumes, potentially due to their smaller market sizes and economic differences. This could be an opportunity for targeted marketing or expansion efforts to improve market penetration.

**Regional Patterns**
Analyzing regional trends reveals:

- **Coastal vs. Inland Cities:** Coastal cities like San Francisco, Los Angeles, and New York City outperform inland cities, potentially due to higher population densities and diverse consumer demographics.
- **Urban vs. Suburban Areas:** Higher sales in major urban centers suggest that population density and economic prosperity play crucial roles in driving demand.


### c/ What is sales performance by quarter over cities?
...
````
**Insights from Quarterly Sales Analysis**
- **Growth Trends:** San Francisco and Los Angeles show steady growth across quarters, likely due to consistent demand and population density.
- **Seasonal Declines:** Certain cities, like Portland and Austin, experience drops in specific quarters, potentially due to seasonal or economic factors affecting consumer spending patterns.
...
### d/ What products sales are prominent due to the cities sales?
...
**Key Insights**
- **Product Preferences:** High intensity in certain cells indicates strong demand for specific products within certain cities. For instance, cities like San Francisco and Los Angeles have high purchases in categories like electronics, reflecting consumer trends and economic status.
- **Low-Demand Products:** Certain products show low sales across all cities, suggesting niche appeal or limited market interest. Targeted promotions or bundling with popular items may improve visibility and sales.

### e/ What insights can be drawn from the density plot of sales by city regarding sales distribution and city-specific spending patterns?
...
```
**Key Insights**
- **Sales Distribution:** Cities like San Francisco and New York City display a broad range of sales values, possibly indicating a mix of high-value purchases and more frequent, lower-value purchases.
- **City-Specific Spending Patterns:** Some cities show peaks at particular sales values, suggesting standard purchase behaviors or common price points among popular products.
