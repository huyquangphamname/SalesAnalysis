...
![Figure Quanity Ordered by Time](/Output/order_QuantityProduct.png){fig-alt="Peaking shopping hours show the graph of order quantity variate by hours and have reach two top sales at 12 a.m and 07 p.m", @fig-Ordered-Quantity-by-Hour}

@fig-Order-Quantity-by-Hour