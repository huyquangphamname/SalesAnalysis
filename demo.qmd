...
**Sales Trends and Seasonal Changes (Normalized Quatitty by Months**
...
1. **Steady Demand Products:** Batteries (both AA and AAA) and **charging cables**, display a relatively consistent demand across all months. This indicates that they are essentials with steady demand throughout the year, likely because they are frequently used or replaced.
2. **Seasonal Peak Products**: Products like **monitors** (20in, 27in, 34in) and **headpones** (Apple AirPods, Bose SoundSport) show peaks in specific months, which might correspond to holiday shopping seasons (e.g., December, October) or back-to-school periods (e.g., Feburary, September). These spikes suggest that comsumers often purchase these items as gifts or during times when they need new tech for school or work setups
